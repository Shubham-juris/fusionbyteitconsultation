  ...
  return (
    <>
      ...
      <div className="flex text-xl text-gray-500 pt-10 gap-8 flex-col sm:pt-20 sm:px-28 text-start sm:text-center px-3 sm:">
        <span>
          The SAGE Foundation has the mission of providing job skills training
        ...
        <span>
          The SAGE Foundation incorporates an Al-driven EdTech platform to
        ...
        <span>
          Over the last two years, SAGE Foundation has trained 15000+ low-income
          youth to get jobs in the BFSI Sector at average salaries between Rs.
          2.40 Lakh to Rs. 3.00 Lakh per annum.
        </span>

        <span>
          SAGE Foundation provides Diploma courses in areas like BFSI, ITES,
      ...
      <div className="bg-[#3D1C38] flex text-xl px-3 text-gray-300 gap-8 flex-col py-16 sm:px-28 text-start sm:text-center ">
        <span>
          SAGE’s employability model is capital efficient, as its technology
