      ...
      <div className="py-12 sm:px-24 ">
        <div className="px-4 py-8 flex gap-3 flex-col">
          ...
          <p className="text-lg text-gray-500">
            Fusion Byte It Consultation  is DRAYTOM VALLEY-based digital innovation & enterprise AI studio that
        ...
        <div className="px-16  text-3xl">
          <p className="py-8">
            ...
            as Fusion Byte It Consultation.
          </p>
          <p className="text-gray-500 text-base">
            Fusion Byte It Consultation has partnered with System Integrators, Interactive/Digital
